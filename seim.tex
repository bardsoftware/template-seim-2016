...
\title{Демонстрация статьи со стилем IEEEtran\\ для конференции SEIM}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Иван Иванов}
\IEEEauthorblockA{Санкт-Петербургский\\Государственный Университет\\
Email: ivanov@spbu.ru}
\and
\IEEEauthorblockN{Пётр Петров}
\IEEEauthorblockA{Московский\\Физико - Технический\\Институт\\
Email: petrov@mipt.ru}
\and
\IEEEauthorblockN{Сидор Сидоров}
\IEEEauthorblockA{Дальневосточный Федеральный\\Университет\\
